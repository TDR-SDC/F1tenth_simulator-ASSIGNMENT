...
public:
    Mux() {
        ...
        nav_drive_sub = n.subscribe(nav_drive_topic, 1, &Mux::nav_drive_callback, this);
    ...
    void nav_drive_callback(const ackermann_msgs::AckermannDriveStamped & msg)  {
         double drive_vel = msg.drive.speed;
         double angle = msg.drive.steering_angle;
         publish_to_drive(drive_vel, angle);
